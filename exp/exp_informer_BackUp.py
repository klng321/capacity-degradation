...
class Exp_Informer(Exp_Basic):
    ...
    def _get_data(self, flag):
        ...
        if flag == 'test':
            ...
            freq = args.freq
            data_set = Data(
                root_path=args.root_path,data_path=args.test_data,  # flag=test,读取test_data文件
                flag=flag,size=[args.seq_len, args.label_len, args.pred_len],
                features=args.features,target=args.target,timeenc=timeenc,freq=freq,cols=args.cols,SOC=args.SOC,label=args.label,begin=args.begin
            )
        elif flag == 'pred':
            shuffle_flag = False
            drop_last = False
            ...
            freq = args.freq
            data_set = Data(
                root_path=args.root_path,data_path=args.train_data,  # flag=test,读取train_data文件
                flag=flag,size=[args.seq_len, args.label_len, args.pred_len],features=args.features,
                target=args.target,inverse=args.inverse,timeenc=timeenc,freq=freq,cols=args.cols,
                SOC=args.SOC,label=args.label,begin=args.begin
            )
